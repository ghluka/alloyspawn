...
import io.github.ghluka.alloyspawn.fluid.StillWaterFluid;
import io.github.ghluka.alloyspawn.AlloyspawnMod;

public class AlloyspawnModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, AlloyspawnMod.MODID);
