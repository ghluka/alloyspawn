package io.github.ghluka.alloyspawn;
...
public class AlloyspawnMod {
	public static final Logger LOGGER = LogManager.getLogger(AlloyspawnMod.class);
	public static final String MODID = "alloyspawn";

	public AlloyspawnMod() {
